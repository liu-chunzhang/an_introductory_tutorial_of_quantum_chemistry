...
export BDF_TMPDIR=/scratch/C7H14-ROHF_119
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/C7H14-ROHF_119 -r C7H14-ROHF.inp > C7H14-ROHF.out
