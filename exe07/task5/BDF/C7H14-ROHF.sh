#!/bin/bash
#BSUB -J intel
#BSUB -o C7H14-ROHF.out
#BSUB -n 8
#BSUB -q cqueue
#BSUB -R "span[hosts=1]"

export BDFHOME=/apps/software/bdf-pkg/build/bdf-pkg-full
export BDF_TMPDIR=/scratch/C7H14-ROHF_421
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/C7H14-ROHF_421 -r C7H14-ROHF.inp > C7H14-ROHF.out
rm -rf .C7H14-ROHF.wrk
