...
export BDF_TMPDIR=/scratch/CH2-CAS22_868
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/CH2-CAS22_868 -r CH2-CAS22.inp > CH2-CAS22.out
rm -rf .CH2-CAS22.wrk
