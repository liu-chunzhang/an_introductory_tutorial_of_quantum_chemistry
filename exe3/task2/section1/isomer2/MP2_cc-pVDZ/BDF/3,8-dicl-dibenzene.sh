...
export BDF_TMPDIR=/scratch/3,8-dicl-dibenzene_791
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/3,8-dicl-dibenzene_791 -r 3,8-dicl-dibenzene.inp > 3,8-dicl-dibenzene.out
