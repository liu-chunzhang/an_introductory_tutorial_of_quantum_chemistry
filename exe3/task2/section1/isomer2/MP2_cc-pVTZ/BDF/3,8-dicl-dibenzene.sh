...
export BDF_TMPDIR=/scratch/3,8-dicl-dibenzene_122
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/3,8-dicl-dibenzene_122 -r 3,8-dicl-dibenzene.inp > 3,8-dicl-dibenzene.out
