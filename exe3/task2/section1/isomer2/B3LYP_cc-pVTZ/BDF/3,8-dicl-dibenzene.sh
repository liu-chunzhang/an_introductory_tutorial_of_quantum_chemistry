...
export BDF_TMPDIR=/scratch/3,8-dicl-dibenzene_118
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/3,8-dicl-dibenzene_118 -r 3,8-dicl-dibenzene.inp > 3,8-dicl-dibenzene.out
