...
export BDF_TMPDIR=/scratch/2,7-dicl-dibenzene_476
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/2,7-dicl-dibenzene_476 -r 2,7-dicl-dibenzene.inp > 2,7-dicl-dibenzene.out
