...
export BDF_TMPDIR=/scratch/2,7-dicl-dibenzene_191
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/2,7-dicl-dibenzene_191 -r 2,7-dicl-dibenzene.inp > 2,7-dicl-dibenzene.out
rm -rf .2,7-dicl-dibenzene.wrk
