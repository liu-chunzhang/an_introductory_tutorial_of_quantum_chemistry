#!/bin/bash
#BSUB -J intel
#BSUB -o trans-1,3-bivinyl-cas44.out
#BSUB -n 8
#BSUB -q cqueue
#BSUB -R "span[hosts=1]"

export BDFHOME=/apps/users/lcz/bdf-pkg
export BDF_TMPDIR=/scratch/trans-1,3-bivinyl-cas44_474
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/trans-1,3-bivinyl-cas44_474 -r trans-1,3-bivinyl-cas44.inp > trans-1,3-bivinyl-cas44.out
rm -rf .trans-1,3-bivinyl-cas44.wrk
