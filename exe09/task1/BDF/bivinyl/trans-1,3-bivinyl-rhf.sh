...
export BDF_TMPDIR=/scratch/trans-1,3-bivinyl-rhf_496
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/trans-1,3-bivinyl-rhf_496 -r trans-1,3-bivinyl-rhf.inp > trans-1,3-bivinyl-rhf.out
rm -rf .trans-1,3-bivinyl-rhf.wrk
