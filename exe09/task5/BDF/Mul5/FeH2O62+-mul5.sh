#!/bin/bash
#BSUB -J intel
#BSUB -o FeH2O62+-mul5.out
#BSUB -n 8
#BSUB -q cqueue
#BSUB -R "span[hosts=1]"

export BDFHOME=/apps/users/lcz/bdf-pkg
export BDF_TMPDIR=/scratch/FeH2O62+-mul5_628
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/FeH2O62+-mul5_628 -r FeH2O62+-mul5.inp > FeH2O62+-mul5.out
rm -rf .FeH2O62+-mul5.wrk
