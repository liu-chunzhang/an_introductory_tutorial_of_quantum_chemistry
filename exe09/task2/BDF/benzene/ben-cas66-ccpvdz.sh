#!/bin/bash
#BSUB -J intel
#BSUB -o ben-cas66-ccpvdz.out
#BSUB -n 8
#BSUB -q cqueue
#BSUB -R "span[hosts=1]"

export BDFHOME=/apps/users/lcz/bdf-pkg
export BDF_TMPDIR=/scratch/ben-cas66-ccpvdz_242
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/ben-cas66-ccpvdz_242 -r ben-cas66-ccpvdz.inp > ben-cas66-ccpvdz.out
rm -rf .ben-cas66-ccpvdz.wrk
