...
export BDF_TMPDIR=/scratch/ben-cas66-ccpvtz_283
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/ben-cas66-ccpvtz_283 -r ben-cas66-ccpvtz.inp > ben-cas66-ccpvtz.out
rm -rf .ben-cas66-ccpvtz.wrk
