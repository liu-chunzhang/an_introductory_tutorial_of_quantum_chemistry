...
export BDF_TMPDIR=/scratch/trans-1,3-bivinyl-rhf_387
...
/apps/users/lcz/bdf-pkg/sbin/bdfdrv.py -tmpdir /scratch/trans-1,3-bivinyl-rhf_387 -r trans-1,3-bivinyl-rhf.inp > trans-1,3-bivinyl-rhf.out
