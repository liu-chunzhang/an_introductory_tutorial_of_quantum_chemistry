...
export BDF_TMPDIR=/scratch/benzeneDimer-TDA_824
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/benzeneDimer-TDA_824 -r benzeneDimer-TDA.inp > benzeneDimer-TDA.out
rm -rf .benzeneDimer-TDA.wrk
