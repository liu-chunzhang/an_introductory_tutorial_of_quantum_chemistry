...
export BDF_TMPDIR=/scratch/benzeneDimer-CIS_112
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/benzeneDimer-CIS_112 -r benzeneDimer-CIS.inp > benzeneDimer-CIS.out
rm -rf .benzeneDimer-CIS.wrk
