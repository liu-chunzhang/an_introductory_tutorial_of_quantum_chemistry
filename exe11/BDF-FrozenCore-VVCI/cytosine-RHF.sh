...
export BDF_TMPDIR=/scratch/cytosine-RHF_611
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/cytosine-RHF_611 -r cytosine-RHF.inp > cytosine-RHF.out
