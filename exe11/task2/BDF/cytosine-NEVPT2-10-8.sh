#!/bin/bash
#BSUB -J intel
#BSUB -o cytosine-NEVPT2-10-8.out
#BSUB -n 8
#BSUB -q cqueue
#BSUB -R "span[hosts=1]"

export BDFHOME=/apps/software/bdf-pkg/build/bdf-pkg-full
export BDF_TMPDIR=/scratch/cytosine-NEVPT2-10-8_242
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/cytosine-NEVPT2-10-8_242 -r cytosine-NEVPT2-10-8.inp > cytosine-NEVPT2-10-8.out
rm -rf .cytosine-NEVPT2-10-8.wrk
