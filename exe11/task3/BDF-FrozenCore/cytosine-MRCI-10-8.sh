...
export BDF_TMPDIR=/scratch/cytosine-MRCI-10-8_931
...
/apps/software/bdf-pkg/build/bdf-pkg-full/sbin/bdfdrv.py -tmpdir /scratch/cytosine-MRCI-10-8_931 -r cytosine-MRCI-10-8.inp > cytosine-MRCI-10-8.out
